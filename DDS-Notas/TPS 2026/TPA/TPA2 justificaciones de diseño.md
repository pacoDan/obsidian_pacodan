...
El patrón observer me permite poder ejecutar acciones ante una determinada acción, si hay una nueva acción llamada por ejemplo "notificación de Donación vencida", entonces se crea una nueva instancia de Observador o ConcreteSubscriter  que implemente la interfaz
